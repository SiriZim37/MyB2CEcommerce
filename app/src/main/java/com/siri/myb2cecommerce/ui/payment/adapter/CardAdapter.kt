package com.siri.myb2cecommerce.ui.payment.adapter
...
class CardAdapter (private val ctx: Context, val listener: CarDItemClickAdapter) : RecyclerView.Adapter<CardAdapter.cardViewHolder>() {
    ...
    override fun onBindViewHolder(holder: cardViewHolder, position: Int) {
        ...
        when (cardItem.brandC) {
            "MASTERCARD" -> holder.cardImage.setImageResource(R.drawable.ic_pay_mastercard)
            "VISA" -> holder.cardImage.setImageResource(R.drawable.ic_pay_visa)
            "AMERICAN_EXPRESS" -> holder.cardImage.setImageResource(R.drawable.ic_pay_american_express)
            "DINERS_CLUB" -> holder.cardImage.setImageResource(R.drawable.ic_pay_diners_club)
            "DISCOVER" -> holder.cardImage.setImageResource(R.drawable.ic_pay_discover)
            "JCB" -> holder.cardImage.setImageResource(R.drawable.ic_pay_jcb)
            "CHINA_UNION_PAY" -> holder.cardImage.setImageResource(R.drawable.ic_pay_unionpay)

            else -> {
                holder.cardImage.setImageResource(R.drawable.ic_pay_mastercard)
            }
        }
